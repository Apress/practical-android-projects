...
public class FunctionExpression extends Expression {
    ...
    /* [pieter][20101208] */ final static int ALERT = 22;
    /* [pieter][20101208] */ final static int TOAST = 23;
    ...
    protected FunctionExpression(int t, Expression e) {
        super();
        oper = t;
        arg2 = e;
    }

    protected FunctionExpression(int t, Expression a1, Expression a2) {
        super();
        arg1 = a1;
        arg2 = a2;
        oper = t;
    ...
    double value(Program p) throws BASICRuntimeError {
        try {
            switch (oper) {
                ...
                /* [pieter][20101208] Classic BASIC Functions */
                case RND :
                    if (r == null)
                        r = p.getRandom();
